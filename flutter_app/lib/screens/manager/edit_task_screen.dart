...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await context.read<TaskProvider>().loadTask(widget.taskId);
      _populateFields();
    });
  }
  ...
  void _populateFields() {
    ...
    if (task != null && !_loaded) {
      ...
      _assignedUserId = task.assignedToId;
      _deadlineAt = task.deadlineAt;
      if (_deadlineAt != null) {
        _deadlineController.text = Helpers.formatDateTime(_deadlineAt!);
      }
      _loaded = true;
    }
  }
  ...
  Future<void> _updateTask() async {
    ...
    if (_assignedUserId == null || _deadlineAt == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Assignee and deadline are required',
    ...
    final success = await taskProvider.updateTask(widget.taskId, {
  ...
  Widget build(BuildContext context) {
    final users = context.watch<UserProvider>().salesUsers;
    ...
    return Scaffold(
      ...
      body: Consumer<TaskProvider>(
        builder: (context, taskProvider, _) {
          if (taskProvider.isLoading && !_loaded) {
